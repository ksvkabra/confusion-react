                        ...
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                             ...
                             <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum" placeholder="Tel Num"  className="form-control" validators={{
                             ...
                             <Row className="form-group">
                                ...
                                <Col md={{size: 3, offset: 1}}>
                                        <Control.select model=".contacctType" name="contactType" className="form-control">
                                    <option>Tel.</option>
                                    <option>Email</option>
                                    </Control.select>
                                </Col>
